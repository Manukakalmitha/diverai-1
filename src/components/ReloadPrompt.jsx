...
function ReloadPrompt() {
    ...
    return (
        <div className="fixed bottom-20 left-4 right-4 md:bottom-6 md:right-6 md:left-auto z-[100] animate-in slide-in-from-bottom-5 duration-500">
            <div className="bg-black-ash/90 backdrop-blur-xl border border-brand/20 rounded-2xl p-4 shadow-2xl flex flex-col gap-3 min-w-[280px] max-w-sm">
                ...
                <div className="flex gap-2 mt-1">
                    {needRefresh && (
                        <button
                            ...
                            className="flex-1 py-2.5 bg-brand hover:bg-brand-light text-slate-950 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-brand-dark/10"
                        >
