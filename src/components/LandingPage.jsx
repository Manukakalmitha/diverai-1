                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 lg:gap-24 mb-16">
                        ...
                        <div className="col-span-2 md:col-span-1 space-y-8">
                            ...
                            <div className="flex gap-4">
                                <a href="https://x.com/diveraitrading" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-slate-600 transition-all">
                                ...
                                <a href="https://github.com/DiverAIItrading" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-slate-600 transition-all">
